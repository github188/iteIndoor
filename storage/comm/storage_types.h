...
/***********************以下为网络参数结构定义***********************/
#define DEFAULT_DEVICEIP				0XC0A8000A 	// 本机IP  192.168.0.10
...
//#define DEFAULT_MANAGERIP1				0XC0A80003 	// 管理员机1 192.168.0.3
#define DEFAULT_MANAGERIP1				0X00	 	// modi by chenbh 2015-03-25
#define DEFAULT_MANAGERIP2				0X00 		// 管理员机2
#define DEFAULT_MANAGERIP3				0X00 		// 管理员机3
...
typedef struct
{
	...
	uint8 isOpenScreen;								// 开机是否开屏 TRUE 开屏 FALSE 不开屏
