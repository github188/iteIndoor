...
#define ESID_MainMonitor_Camera			 (g_China ? (g_Big5 ? "監視社區" : "监视社区") : "Monitor Community")
#define ESID_MainMonitor_Room			 (g_China ? (g_Big5 ? "家居監視" : "家居监视") : "RoomCamera")
#define ESID_DevManager                  (g_China ? (g_Big5 ? "管理員機" : "管理员机") : "Admin")
#define ESID_DevArea                     (g_China ? (g_Big5 ? "區口機" : "区口机") : "Prim.Entry")
#define ESID_DevStair                    (g_China ? (g_Big5 ? "梯口機" : "梯口机") : "Sec.Entry")
#define ESID_DevRoom                     (g_China ? (g_Big5 ? "室內機" : "室内机") : "Indoor Terminal")
#define ESID_DevPhone                    (g_China ? (g_Big5 ? "普通電話" : "普通电话") : "Phone")
#define ESID_DevDoorPhone                (g_China ? (g_Big5 ? "門前機" : "门前机") : "Camera")
#define ESID_DevDoorNet                  (g_China ? (g_Big5 ? "網絡門前機" : "网络门前机") : "IP Camera")
#define ESID_DevGateWay                  (g_China ? (g_Big5 ? "家庭網關" : "家庭网关") : "Gateway")
...
#define ESID_Inter_EnterUserNo			 (g_China ? (g_Big5 ? "請輸入房號" : "请输入房号") : "Pls enter a number")
#define ESID_Inter_EnterFJNo			 (g_China ? (g_Big5 ? "請輸入1位分機號" : "请输入位1分机号") : "Pls enter a number")
#define ESID_Inter_WrongNo               (g_China ? (g_Big5 ? "輸入號碼錯誤!" : "输入号码错误!") : "Wrong number!")
...
#define ESID_Inter_CaptureSuccess        (g_China ? (g_Big5 ? "抓拍成功!" : "抓 拍 成 功!") : "OK!")
...
#define ESID_Inter_Search                (g_China ? (g_Big5 ? "搜索中,請稍後..." : "搜索中,请稍候...") : "Searching...")
#define ESID_Inter_Monitor               (g_China ? (g_Big5 ? "監視中..." : "监视中...") : "Monitoring...")
#define ESID_Inter_busy                  (g_China ? (g_Big5 ? "對方忙!" : "对方忙!") : "Busy Line!")
#define ESID_Inter_ConnFailed            (g_China ? (g_Big5 ? "連接失敗!" : "连接失败!") : "Failed!")
